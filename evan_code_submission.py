...
label_train_num = label_train[:,0]
label_train = label_train[:,1:]
data_train_num = data_train[:,0]
...
#put data at beginning
data_test = np.concatenate((np.arange(2000)[:, np.newaxis], data_test), axis=1)


label_test_num = label_test[:,0]
label_test = label_test[:,1:]

#data_test_num = data_test[:,0]
